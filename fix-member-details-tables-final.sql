-- Fix member details tables to match the code expectations (FINAL CORRECTED VERSION)
...
SELECT 
    ...
    (SELECT COUNT(*) FROM events WHERE title IS NOT NULL AND event_date IS NOT NULL) as events_properly_configured; 