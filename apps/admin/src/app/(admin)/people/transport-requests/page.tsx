'use client';
// Force update - Modern Transport Requests UI
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-12">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            ...
            >
              <Link href="/people/transport-requests/new">
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-6 border-t border-slate-200">
              <span className="text-sm font-medium text-slate-600">
                Showing {filteredRequests.length} of {transportRequests.length} requests
                {filteredRequests.length !== transportRequests.length && ` (filtered)`}
              </span>
            </div>
          </div>
        </div>
                    ...
                    <TableCell className="text-right py-4">
                      <div className="flex justify-end gap-2">
                        <Button 
                          variant="ghost" 
                          size="sm" 
                          onClick={() => router.push(`/people/transport-requests/${request.id}`)}
                        ...
                        <Button 
                          variant="ghost" 
                          size="sm" 
                          onClick={() => router.push(`/people/transport-requests/${request.id}?mode=edit`)}
