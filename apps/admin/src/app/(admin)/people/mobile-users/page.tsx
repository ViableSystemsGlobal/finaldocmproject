...
export default function MobileUsersPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-teal-100 flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 w-20 h-20 border-4 border-transparent border-t-teal-400 rounded-full animate-spin mx-auto" style={{ animationDuration: '1.5s', animationDirection: 'reverse' }}></div>
          </div>
          <h2 className="text-2xl font-bold text-slate-800 mb-2">Loading Mobile Users</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-teal-100">
        ...
        <div className="mb-12">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-teal-500 to-green-500 rounded-2xl blur-sm opacity-75"></div>
                <div className="relative bg-gradient-to-r from-teal-500 to-green-500 p-4 rounded-2xl">
              ...
              <div>
                ...
                <p className="text-xl text-slate-600 mt-2">
                  Manage mobile application users and access
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal-500 to-teal-600 p-6 text-white shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  <p className="text-teal-100 text-sm font-medium">Total Mobile Users</p>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-teal-100 text-sm font-medium">Registered users</span>
              </div>
            </div>
          </div>
          ...
          <div className="group cursor-pointer">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500 to-green-600 p-6 text-white shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-green-100 text-sm font-medium">Recently active</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-8">
            ...
            <div className="relative mb-6">
              ...
              <Input
                ...
                className="pl-12 h-12 border-2 border-slate-200 rounded-xl bg-white/50 focus:border-teal-500 focus:ring-teal-500"
              />
            </div>
          ...
          <Table>
            <TableHeader className="bg-gradient-to-r from-slate-100 to-slate-200">
              <TableRow>
                ...
                <TableHead className="py-4 font-bold text-slate-700">Push Tokens</TableHead>
            ...
            <TableBody>
              {filteredUsers.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-16">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-slate-800 mb-2">No mobile users found</h3>
                        <p className="text-slate-600">
                          {searchQuery.trim() !== ''
                            ? 'No users match your search criteria.'
                            : 'No mobile users have been registered yet.'
                          }
                        </p>
                      </div>
                    </div>
                ...
                filteredUsers.map((user) => {
                  // Calculate push tokens for this user
                  const pushTokens = user.devices && Array.isArray(user.devices) 
                    ? user.devices.filter(device => device.push_token && device.push_token.trim() !== '')
                    : [];
                  ...
                  return (
                    <TableRow key={user.id} className="hover:bg-white/80 transition-colors">
                      ...
                      <TableCell className="py-4">
                          ...
                          {pushTokens.length > 0 ? (
                            <>
                              ...
                              <span className="text-sm font-medium text-green-700">
                                {pushTokens.length} token{pushTokens.length !== 1 ? 's' : ''}
                              </span>
                            </>
                          ) : (
                            <>
                        ...
                        {user.devices && Array.isArray(user.devices) && user.devices.length > 0 && (
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent className="bg-white/95 backdrop-blur-xl border border-white/20 rounded-2xl">
          <DialogHeader>
            <DialogTitle className="text-xl font-bold text-slate-800">Delete Mobile User</DialogTitle>
            <DialogDescription className="text-slate-600">
              Are you sure you want to delete this mobile user? This will revoke their app access. This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button 
