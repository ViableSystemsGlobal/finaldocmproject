-- Disable existing triggers temporarily
...
-- Create a simplified function that works with existing email_queue structure
...
-- Create a simplified lifecycle trigger
...
COMMENT ON FUNCTION auto_send_welcome_email_simple() IS 'Simplified welcome email automation with error handling and column detection';
COMMENT ON FUNCTION auto_send_lifecycle_welcome_email_simple() IS 'Simplified lifecycle welcome email automation with error handling and column detection'; 