-- Create communication_settings table for the communications settings page
...
DROP POLICY IF EXISTS "Allow authenticated users to read communication settings" ON communication_settings;
DROP POLICY IF EXISTS "Allow authenticated users to update communication settings" ON communication_settings;
...
DROP TRIGGER IF EXISTS trigger_communication_settings_updated_at ON communication_settings;
DROP FUNCTION IF EXISTS update_communication_settings_updated_at();
