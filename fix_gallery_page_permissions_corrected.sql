-- Fix gallery page CMS permissions (CORRECTED VERSION)
-- Run this in your Supabase SQL editor

-- Drop existing policies to avoid conflicts
DROP POLICY IF EXISTS "Allow public read access to gallery page" ON pages;
DROP POLICY IF EXISTS "Allow public read access to gallery page sections" ON page_sections;
...
BEGIN
    ...
    -- Insert hero section ONLY if it doesn't exist (don't overwrite existing)
    ...
    -- Insert photo galleries section ONLY if it doesn't exist
    IF NOT photo_galleries_exists THEN
        INSERT INTO page_sections (page_id, type, "order", props)
        VALUES (
            gallery_page_id,
            'photo_galleries',
    ...
    -- Insert video galleries section ONLY if it doesn't exist
    IF NOT video_galleries_exists THEN
        INSERT INTO page_sections (page_id, type, "order", props)
        VALUES (
            gallery_page_id,
            'video_galleries',
