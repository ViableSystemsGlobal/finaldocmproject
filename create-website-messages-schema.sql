-- Create Website Messages System
...
-- Update one message to show it has been responded to
UPDATE public.website_messages 
SET status = 'responded', 
    response_notes = 'Called and provided service times. Invited to newcomers lunch.',
    responded_at = NOW(),
    responded_by = (SELECT id FROM auth.users LIMIT 1)
